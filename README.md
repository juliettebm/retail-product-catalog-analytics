...
On me confie le catalogue produit d'un e-commerçant britannique (1 067 371 lignes de transaction, Online Retail II) : les fiches produit sont connues pour être incohérentes, mais personne n'a chiffré l'ampleur du problème. Je qualifie les anomalies, je chiffre leur impact réel sur le chiffre d'affaires, et je priorise les corrections en conséquence. Même jeu de données que `customer-analytics-retail`, mais un angle différent : le produit et son catalogue, pas le client.
